...
var prototype$11 = vegaUtil.inherits(Flatten, vegaDataflow.Transform);
...
var prototype$12 = vegaUtil.inherits(Fold, vegaDataflow.Transform);
...
var prototype$13 = vegaUtil.inherits(Formula, vegaDataflow.Transform);
...
var prototype$14 = vegaUtil.inherits(Generate, vegaDataflow.Transform);
...
var prototype$15 = vegaUtil.inherits(Impute, vegaDataflow.Transform);
...
var prototype$16 = vegaUtil.inherits(JoinAggregate, Aggregate);
...
var prototype$17 = vegaUtil.inherits(Lookup, vegaDataflow.Transform);
...
var prototype$18 = vegaUtil.inherits(Pivot, Aggregate);

prototype$18._transform = prototype$18.transform;
...
function aggregateParams(_, pulse) {
  ...
  value  = _.value,
      ...
      fields = vegaUtil.accessorFields(key$$1).concat(vegaUtil.accessorFields(value)),
...
var prototype$19 = vegaUtil.inherits(PreFacet, Facet);
...
var prototype$20 = vegaUtil.inherits(Project, vegaDataflow.Transform);
...
prototype$20.transform = function(_, pulse) {
  ...
  pulse.visit(pulse.ADD, function(t) {
    var dt = derive$$1(t, vegaDataflow.ingest({}));
    lut[vegaDataflow.tupleid(t)] = dt;
    out.add.push(dt);
  });

  pulse.visit(pulse.MOD, function(t) {
    out.mod.push(derive$$1(t, lut[vegaDataflow.tupleid(t)]));
  });
...
var prototype$21 = vegaUtil.inherits(Proxy, vegaDataflow.Transform);
...
var prototype$22 = vegaUtil.inherits(Relay, vegaDataflow.Transform);
...
var prototype$23 = vegaUtil.inherits(Sample, vegaDataflow.Transform);
...
var prototype$24 = vegaUtil.inherits(Sequence, vegaDataflow.Transform);
...
prototype$24.transform = function(_, pulse) {
  ...
  this.value = d3Array.range(_.start, _.stop, _.step || 1).map(vegaDataflow.ingest);
...
var prototype$25 = vegaUtil.inherits(Sieve, vegaDataflow.Transform);
...
var prototype$26 = vegaUtil.inherits(TupleIndex, vegaDataflow.Transform);
...
var prototype$27 = vegaUtil.inherits(Values, vegaDataflow.Transform);
...
var prototype$29 = WindowState.prototype;

prototype$29.init = function() {
  this.windows.forEach(function(_) { _.init(); });
  if (this.cell) this.cell.init();
};

prototype$29.update = function(w, t) {
  var self = this,
      cell = self.cell,
      wind = self.windows,
      data = w.data,
...
var prototype$28 = vegaUtil.inherits(Window, vegaDataflow.Transform);
...
prototype$28.group = function(key$$1) {
  var self = this,
