...
class DownloadEG():
	...
	def __init__(self):
		...
		self.update_dataset_specs()



	def update_dataset_specs(self):
		with open('utils/dataset_specs.json') as f:
			data = json.load(f)
		self.dataset_url = data["dataset_url"]
		self.zip_fname = data["zip_fname"]
		self.data_path = data["data_path"]
		self.imgs_urls = data["imgs_urls"]
		self.masks_folder = data["masks_folder"]
		self.crop_txt = data["crop_txt"]
